...
$biaya_perjalanan_id = $_POST['biaya_perjalanan_id'];
...
$query = mysqli_query($koneksi, "INSERT INTO kuitansi (sppd_id, biaya_perjalanan_id, diterima_dari, untuk_pembayaran, total_lumpsum, total_penginapan, total_transportasi) VALUES ('$sppd_id', '$biaya_perjalanan_id', '$diterima_dari', '$untuk_pembayaran', '$total_lumpsum', '$total_penginapan', '$total_transportasi')");
