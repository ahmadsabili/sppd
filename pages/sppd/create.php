    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Tambah Surat Perintah Perjalanan Dinas (SPPD)</h4>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="controllers/sppd/store.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="no_sppd" name="no_sppd" required>
                                </div>
                                <div class="form-group">
                                    <label for="pejabat_pemberi_perintah">Pejabat yang Memberi Perintah</label>
                                    <input type="text" class="form-control" id="pejabat_pemberi_perintah" name="pejabat_pemberi_perintah" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mata_anggaran" name="mata_anggaran" required>
                                </div>
                                <div class="form-group">
