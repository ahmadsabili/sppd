...
$kuitansi = mysqli_query($koneksi, "SELECT * FROM kuitansi WHERE sppd_id = '$id_sppd'");
    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Edit Kuitansi</h4>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="controllers/kuitansi/update.php" method="POST">
                                <input type="hidden" name="id_kuitansi" value="<?= $kuitansi['id_kuitansi'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="diterima_dari" name="diterima_dari" required value="<?= $kuitansi['diterima_dari'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="untuk_pembayaran">Untuk Pembayaran</label>
                                    <input type="text" class="form-control" id="untuk_pembayaran" name="untuk_pembayaran" required value="<?= $kuitansi['untuk_pembayaran'] ?>">
                                </div>
