...
if ($_SESSION['role'] == 'admin') {
    ...
    $nppd = mysqli_query($koneksi, "SELECT * FROM nppd JOIN kota ON nppd.kota_id = kota.id_kota JOIN kendaraan ON nppd.kendaraan_id = kendaraan.id_kendaraan WHERE pegawai_id IN ($pegawai_id)");
}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if (mysqli_num_rows($cek_spt) > 0) {
                                                        $spt = mysqli_fetch_assoc($cek_spt);
                                                        if ($spt['no_spt'] == '') {
                                                            echo '<a href="javascript:void(0)" class="btn btn-warning btn-sm" title="Edit SPT"><i class="fas fa-clock"></i></a>';
                                                        } else {
                                                            echo '<a href="index.php?page=edit-spt&id_spt=' . $spt['id_spt'] . '" class="btn btn-success btn-sm"  title="Lihat SPT"><i class="fas fa-check"></i></a>';
                                                        }
                                                    } else {
